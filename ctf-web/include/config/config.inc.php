...
const CONFIG_SITE_NAME = 'CTF!';
const CONFIG_SITE_SLOGAN = 'CTF, th3 b3st g4m3!! ';
const CONFIG_SITE_DESCRIPTION = '';
const CONFIG_SITE_URL = 'https://yourdomain.com/';
const CONFIG_SITE_URL_STATIC_RESOURCES = 'https://yourdomain.com/';
...
const CONFIG_EMAIL_FROM_NAME = 'RTF CTF!';
